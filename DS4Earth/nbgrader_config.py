...
# server set up.
c.CourseDirectory.course_id = "DS4Earth"
...
#c.ClearSolutions.code_stub = {'octave': "% YOUR CODE HERE\nerror('No Answer Given!')", 'python': '# YOUR CODE HERE\nraise NotImplementedError()', 'java': '// YOUR CODE HERE', 'matlab': "% YOUR CODE HERE\nerror('No Answer Given!')"}
